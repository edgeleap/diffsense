...
1. DiffSense is a terminal call that creates a AI generated git message. Using the built in Apple Inteligence local LLM capability. For free and with complete privacy.
