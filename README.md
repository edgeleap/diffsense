...
- If you want to use DiffSense with AI agents that commits for them selfs in terminal. You can omit the input step in the shortcut. That way the AI agent can do each step required right in terminal
